...
C     !INTERFACE:
     ...
     I        trIdentity, trUseGMRedi, trUseKPP, trUseSlantwise,
     O        KappaRTr,
     I        myThid )
...
C     trUseSlantwise :: this tracer use slantwise
...
C     KappaRTr   :: Net diffusivity for this tracer (trIdentity)
      ...
      INTEGER trIdentity
      LOGICAL trUseGMRedi, trUseKPP, trUseSlantwise
