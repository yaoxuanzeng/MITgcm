...
C                    (global mean on the order 0.09 - 0.1 W/m^2)
      ...
      Real*8 geothermalFlux(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
...
C     [0,1]         :: End points for interpolation
     ...
     &               , pLoad0, pLoad1
      ...
      Real*8  geothFlux0(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8  geothFlux1(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
...
c        ENDIF
     ...
     &                        intime1, myIter, myThid )
         CALL EXCH_XY_RS (  geothFlux0,  myThid  )
         CALL EXCH_XY_RS (  geothFlux1,  myThid  )
        ENDIF
